...
const CategoryWiseProductDisplay = ({ category, heading }) => {
  ...
  return (
    <div className="relative container mx-auto my-4 px-6 ">
      ...
      <div
        className="grid grid-cols-[repeat(auto-fit,minmax(300px,300px))] justify-between md:gap-6 overflow-x-scroll scrollbar-none transition-all duration-300 ease-in-out"
